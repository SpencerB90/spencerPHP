                ...
                <div class="col-md-8 ml-auto mr-auto">
                    ...
                    <form class="contact-form" action="" method="POST"> <!-- added in action and method-->
                        <div class="row"><!--starts row-->
                          ...
                          <div class="col-md-6">
                              <label a href= "imageupload.php">Click to Edit Profile Picture</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input value="<?php if(!$_POST){echo $_SESSION['last_name'];} else{echo $_POST['last_name'];} ?>" type="text" class="form-control" name="last_name" placeholder="Last Name">
                              </div>
                            </div>
                          ...
                          <label>Title</label>
                            ...
                            <textarea value="<?php if(!$_POST){echo $_SESSION['description'];} else{echo $_POST['description'];} ?>" class="form-control" rows="4" name="description" placeholder="Tell everyone a little about you.."></textarea>
                            <div class="row">
