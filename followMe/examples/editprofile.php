                        ...
                        <div class="row"><!--starts row-->
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input value="<?php  $_POST['first_name'] ?>" type="text" class="form-control" name="first_name" placeholder="First Name">
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                  ...
                                  <input value="<?php $_POST['last_name'] ?>" type="text" class="form-control" name="last_name" placeholder="Last Name">
                              </div>
                            </div>
                            ...
                            <div class="input-group">
                              ...
                              <input value="<?php $_POST['title'] ?>" type="text" class="form-control" name="title" placeholder="Title">
                            </div>


                            <label>Description</label>
                            <textarea value="<?php$_POST['description'] ?>" class="form-control" rows="4" name="description" placeholder="Tell everyone a little about you.."></textarea>
                            <div class="row">
